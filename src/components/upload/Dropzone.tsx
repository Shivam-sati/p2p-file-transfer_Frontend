...
export const Dropzone = ({ onFileSelect }: DropzoneProps) => {
  ...
  const { isUploading, progress, fileName, fileSize, error } = useUploadStore();
      ...
      <AnimatePresence mode="wait">
        {!isUploading ? (
            ...
            <div className="relative z-10 flex flex-col items-center gap-8">
              ...
              <div className="space-y-4">
                ...
                <p className="text-slate-400 max-w-sm mx-auto leading-relaxed text-sm">
                  Automatic WebRTC peer detection enabled. Large files are automatically chunked for maximum reliability.
                </p>
              </div>
          ...
          >
            ...
            <ProgressBar 
              progress={progress} 
              label={error ? 'Upload Failed' : progress === 100 ? 'Upload Complete' : 'Uploading chunks...'}
